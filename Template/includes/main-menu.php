<?php
  ...
  $menu_items['pages.php']['children']['mail.php'] = array('icon' => 'fa-lock', 'text' => 'Mail Page', 'notification' => '');
  ...
  $menu_items['icons.php'] = array('icon' => ' fa-asterisk', 'text' => 'Icons', 'notification' => '7', 'notification_color' => 'purple', 'class' => 'blue');
...
<div class="sidebar-profile">
  ...
  <div class="user-info">
    <a href="profile.php">Samantha Lenna Wilson</a>
  </div>
</div>
  ...
  ?>
    <li class="<?php echo $class; ?>">
      <a href="<?php echo $item_link; ?>">
        ...
        <span class="menu-text"><?php echo $menu_item['text'] ;?></span>

        <?php if ($menu_item['notification'] != '') { ?>
        <span class="notification <?php echo $menu_item['notification_color'] ;?>"><?php echo $menu_item['notification']; ?></span>
        <?php } ?>
      </a>
      ...
      if (isset($menu_item['children'])) {
        if ($child_open) {
          echo '<ul class="child open">';
        } else {
          echo '<ul class="child">';
        }

        foreach ($menu_item['children'] as $ckey => $child_item) {
          $class = '';
          if ($url == $ckey) {
            $class = 'active';
          }
          echo '<li class="' . $class . '"><a href="' . $ckey . '">' . $child_item['text'] . '</a></li>';
        }
        echo '</ul>';
      }
