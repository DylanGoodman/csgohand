				...
				<div class="col-md-12 grid_box1">
					<div style="padding:0;background-color: #080505;" class="calender widget-shadow">
						<?php if(!isset($_SESSION['steamid'])){ ?>
							<h2 style="color:#0072C9" class="title3 text-center">Welcome to CSGOHand V2.0</h2>
						<?php } else { ?>
							<h2 style="color:#0072C9" class="title3 text-center">Welcome back, <?php echo $steamprofile['personaname']; ?>.</h2>
						<?php } ?>
						<?php if(!isset($_SESSION['steamid'])){ ?>
