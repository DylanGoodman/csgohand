			...
			<div class="main-page row" style="margin:0;">
				<div class="col-md-12 grid_box1">
                    ...
                    <div class="col-md-4 profile widget-shadow">
                        ...
                        <div class="profile-text"> <!-- 12,000 exp per level -->
                            ...
                            <div class="progress progress-striped active">
                                <div class="bar black" style="width: <?php echo $level->getPercentageLevel($_SESSION['steamid']); ?>%;"></div>
                            </div>
                    ...
                    <div class="col-md-4 profile widget-shadow">
						...
						<div style="background-color:#bcbcbc;padding:5px;" class="profile-btm">
                            <p style="color:#011930;text-align: center;font-size:.8em">You don't have 'CSGOHand.com' in your Steam Username!</p>
                        </div>
						<div class="profile-top">
