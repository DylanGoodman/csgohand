			...
			<div class="main-page row" style="margin:0;">
				...
				<div class="col-md-4 grid_box1">
					<div style="padding:0" class="calender widget-shadow">
						...
						<div style="margin-top:0" class="row">
							<button style="border-radius:0;" type="clear" class="btn col-md-3  btn-r-blk2">+100</button>
							<button style="border-radius:0;" type="clear" class="btn col-md-3  btn-r-blk2">+1000</button>
							<button style="border-radius:0;" type="clear" class="btn col-md-3  btn-r-blk2">+5000</button>
							<button style="border-radius:0;" type="clear" class="btn col-md-3  btn-r-blk2">+10000</button>
							<button style="border-radius:0;" type="clear" class="btn col-md-2 btn-r-blk2">1/2</button>
							<button style="border-radius:0;" type="clear" class="btn col-md-2  btn-r-blk2">2x</button>
							<button style="border-radius:0;" type="clear" class="btn col-md-2  btn-r-blk2">0</button>
							<button style="border-radius:0;" type="clear" class="btn col-md-3  btn-r-blk2">Last</button>
							<button style="border-radius:0;" type="clear" class="btn col-md-3  btn-r-blk2">Max</button>
						</div>
					</div>
